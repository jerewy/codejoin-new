...
export default function EnhancedPromptHelper({ onPromptSelect }: PromptHelperProps) {
    ...
    return (
      <div className="p-4 bg-card rounded-lg border border-border shadow-sm">
        ...
        <div className="mb-4">
          ...
          <div className="bg-muted p-3 rounded-md text-sm text-muted-foreground max-h-60 overflow-y-auto">
